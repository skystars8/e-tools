...
const APP_ID: u8 = 24;
const SUITE_NAME: &str = "PBKDF2-SHA512-Kalyna-256-256-GCM-32768-records";
const PAYLOAD_ALGORITHM: &str = "Kalyna-256/256-GCM";
...
fn seal_record(
    ...
    let tag = cipher
        .encrypt(nonce, aad, message, &mut ciphertext)
...
fn open_record(
    ...
    Kalyna256_256Gcm::new(key)
        .decrypt(nonce, aad, body, tag, &mut plaintext)
        .map_err(|_| integrity_error())?;
    Ok(plaintext)
}
