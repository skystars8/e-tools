...
const APP_ID: u8 = 13;
const SUITE_NAME: &str = "Argon2id-SNOW-V-GCM-1048576-records";
...
fn seal_record(
    ...
    let cipher = snowv_gcm::SnowVGcm::new_from_slice(key).map_err(|_| integrity_error())?;
    let nonce = aead::Nonce::<snowv_gcm::SnowVGcm>::from_slice(nonce);
    cipher
