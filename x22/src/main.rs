...
const APP_ID: u8 = 22;
const SUITE_NAME: &str = "PBKDF2-SHA256-MKV128-256-GCM-262144-records";
const PAYLOAD_ALGORITHM: &str = "MKV128-256-GCM";
...
fn seal_record(
    ...
    let cipher = Mkv128256Gcm::new_from_slice(key).map_err(|_| integrity_error())?;
    cipher
