...
const APP_ID: u8 = 40;
const PAYLOAD_ALGORITHM: &str = "SM4";
const SUITE_NAME: &str = "PBKDF2-SHA256 / SM4 / HMAC-SHA256-EtM";
...
fn transform_payload(
    ...
    use sm4::cipher::{Array, BlockCipherEncrypt, KeyInit};
    let key_array: [u8; 16] = key.try_into().map_err(|_| integrity_error())?;
    let cipher = sm4::Sm4::new(&key_array.into());
