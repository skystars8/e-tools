...
const APP_ID: u8 = 35;
const PAYLOAD_ALGORITHM: &str = "ARIA-256";
const SUITE_NAME: &str = "PBKDF2-SHA256 / ARIA-256 / HMAC-SHA256-EtM";
...
fn transform_payload(
    ...
    use aria::cipher::{Array, BlockCipherEncrypt, KeyInit};
    let key_array: [u8; 32] = key.try_into().map_err(|_| integrity_error())?;
    let cipher = aria::Aria256::new(&key_array.into());
