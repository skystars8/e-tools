...
const APP_ID: u8 = 2;
const SUITE_NAME: &str = "scrypt-ChaCha20-Poly1305-131072-records";
...
fn seal_record(
    ...
    let cipher =
        chacha20poly1305::ChaCha20Poly1305::new_from_slice(key).map_err(|_| integrity_error())?;
    let nonce = aead::Nonce::<chacha20poly1305::ChaCha20Poly1305>::try_from(&nonce[..])
