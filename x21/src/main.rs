...
const APP_ID: u8 = 21;
const SUITE_NAME: &str = "PBKDF2-SHA224-Saturnin-CTR-Cascade-131072-records";
const PAYLOAD_ALGORITHM: &str = "Saturnin-CTR-Cascade";
...
fn seal_record(
    ...
    lib_q_saturnin::SaturninAead::new()
        .encrypt_bytes(key, nonce, message, Some(aad))
...
fn open_record(
    ...
    lib_q_saturnin::SaturninAead::new()
        .decrypt_bytes(key, nonce, ciphertext, Some(aad))
        .map_err(|_| integrity_error())
}
