...
const APP_ID: u8 = 36;
const PAYLOAD_ALGORITHM: &str = "Camellia-256";
const SUITE_NAME: &str = "PBKDF2-SHA256 / Camellia-256 / HMAC-SHA256-EtM";
...
fn transform_payload(
    ...
    use camellia::cipher::{Array, BlockCipherEncrypt, KeyInit};
    let key_array: [u8; 32] = key.try_into().map_err(|_| integrity_error())?;
    let cipher = camellia::Camellia256::new(&key_array.into());
