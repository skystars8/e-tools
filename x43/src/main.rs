...
const APP_ID: u8 = 43;
const PAYLOAD_ALGORITHM: &str = "GIFT-128";
const SUITE_NAME: &str = "PBKDF2-SHA256 / GIFT-128 / HMAC-SHA256-EtM";
...
fn transform_payload(
    ...
    use gift_cipher::cipher::{Array, BlockCipherEncrypt, KeyInit};
    let key_array: [u8; 16] = key.try_into().map_err(|_| integrity_error())?;
    let cipher = gift_cipher::Gift128::new(&key_array.into());
