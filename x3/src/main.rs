...
const APP_ID: u8 = 3;
const SUITE_NAME: &str = "PBKDF2-SHA224-Ascon-AEAD128-262144-records";
...
fn seal_record(
    ...
    let cipher = ascon_aead::AsconAead128::new_from_slice(key).map_err(|_| integrity_error())?;
    let nonce = aead::Nonce::<ascon_aead::AsconAead128>::try_from(&nonce[..])
