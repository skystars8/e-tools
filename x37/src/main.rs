...
const APP_ID: u8 = 37;
const PAYLOAD_ALGORITHM: &str = "Serpent-256";
const SUITE_NAME: &str = "PBKDF2-SHA256 / Serpent-256 / HMAC-SHA256-EtM";
...
fn transform_payload(
    ...
    use serpent::cipher::{Array, BlockCipherEncrypt, KeyInit};
    let cipher = serpent::Serpent::new_from_slice(key).map_err(|_| integrity_error())?;
