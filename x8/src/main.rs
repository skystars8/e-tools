...
const APP_ID: u8 = 8;
const SUITE_NAME: &str = "scrypt-MORUS-1280-128-262144-records";
...
fn seal_record(
    ...
    let (mut ciphertext, tag) = morus::Morus::new(nonce, key).encrypt(message, aad);
