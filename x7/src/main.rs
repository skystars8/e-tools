...
const APP_ID: u8 = 7;
const SUITE_NAME: &str = "Argon2id-ISAP-Keccak-128A-131072-records";
...
fn seal_record(
    ...
    let cipher = isap_aead::IsapKeccak128A::new_from_slice(key).map_err(|_| integrity_error())?;
    let nonce = aead::Nonce::<isap_aead::IsapKeccak128A>::try_from(&nonce[..])
