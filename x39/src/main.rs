...
const APP_ID: u8 = 39;
const PAYLOAD_ALGORITHM: &str = "Kuznyechik";
const SUITE_NAME: &str = "PBKDF2-SHA256 / Kuznyechik / HMAC-SHA256-EtM";
...
fn transform_payload(
    ...
    use kuznyechik::cipher::{Array, BlockCipherEncrypt, KeyInit};
    let key_array: [u8; 32] = key.try_into().map_err(|_| integrity_error())?;
    let cipher = kuznyechik::Kuznyechik::new(&key_array.into());
