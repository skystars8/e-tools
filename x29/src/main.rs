...
const APP_ID: u8 = 29;
const SUITE_NAME: &str = "PBKDF2-SHA384-RC6-256-CTR-HMAC-SHA256-32768-records";
const PAYLOAD_ALGORITHM: &str = "RC6-256";
...
fn apply_payload_cipher(
    ...
    type Rc6_256 = rc6::RC6<u32, U20, U32>;
    type Cipher = ctr::Ctr128BE<Rc6_256>;
...
fn make_nonce(_prefix: &[u8; PREFIX_SIZE], counter: u64) -> [u8; NONCE_SIZE] {
...
mod tests {
    ...
    fn adjacent_record_counters_do_not_overlap() {
        ...
        apply_payload_cipher(&key, &make_nonce(&prefix, 0), &mut record_zero).unwrap();
        apply_payload_cipher(&key, &make_nonce(&prefix, 1), &mut record_one).unwrap();
