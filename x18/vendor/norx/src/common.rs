use crate::constant::{BLOCK_LENGTH, S, STATE_LENGTH, U};
    ...
    F: FnOnce(&mut [u8; STATE_LENGTH]),
{
    ...
    fn le_from_slice(arr: &mut [U; S]) {
        #[cfg(feature = "W16")]
        LittleEndian::from_slice_u16(arr);
        #[cfg(feature = "W32")]
        LittleEndian::from_slice_u32(arr);
        #[cfg(feature = "W64")]
...
pub fn branch_x4(state: &[U; S]) -> ([U; S], [U; S], [U; S], [U; S]) {
    use crate::constant::{R, W};
